...
void elliptical_pile_height(HashTable* HT_Node_Ptr, Element *EmTemp, 
  ...
  //printf("elliptical_pile_height() got to 1\n"); fflush(stdout);
  //printf("EmTemp=%d\n",EmTemp); fflush(stdout);
  ...
  //printf("elliptical_pile_height() got to 2\n"); fflush(stdout);
  ...
  for(int inode=0;inode<9;inode++) {
    //printf("nodes=%d [%d %d] \n",nodes[inode],nodes[inode][0],nodes[inode][1]);
    //printf("elliptical_pile_height() got to 3\n"); fflush(stdout);
    ...
    //printf("elliptical_pile_height() got to 4\n"); fflush(stdout);
    ...
    for(int ipile=0;ipile<pileprops->numpiles;ipile++) {
      ...
      //printf("elliptical_pile_height() got to 4.1\n"); fflush(stdout);
      
      //printf("Cen = %g, %g\n",pileprops->xCen[ipile],pileprops->yCen[ipile]); fflush(stdout);
      
      //printf("ndtemp = %d\n",ndtemp); fflush(stdout);
      //printf("ndcoord = %d\n",ndcoord); fflush(stdout);
      
      //printf("ndcoord = %g, %g\n",ndcoord[0],ndcoord[1]); fflush(stdout);
      
      //get position relative to pile center
      //double major=ndcoord[0]*matprops->LENGTH_SCALE-pileprops->xCen[ipile];
      double major=ndcoord[0]-pileprops->xCen[ipile];
      
      //printf("elliptical_pile_height() got to 4.1.1\n"); fflush(stdout);

      //double minor=ndcoord[1]*matprops->LENGTH_SCALE-pileprops->yCen[ipile];
      double minor=ndcoord[1]-pileprops->yCen[ipile];
      //printf("elliptical_pile_height() got to 4.1.2\n"); fflush(stdout);
	...
	pileprops->majorrad[ipile];
      ...
      //printf("elliptical_pile_height() got to 4.2\n"); fflush(stdout);
	...
	pileprops->minorrad[ipile];
      ...
      //printf("elliptical_pile_height() got to 4.3\n"); fflush(stdout);
      
      /* calculate pile height based on non dimensional position relative to
	 center of pile */
#ifdef PARABALOID      
      //printf("elliptical_pile_height() got to 4.4\n"); fflush(stdout);
      //height = pileprops->pileheight[ipile]/
      //matprops->HEIGHT_SCALE*(1.-major*major-minor*minor);
      height = pileprops->pileheight[ipile]*(1.-major*major-minor*minor);
      //printf("elliptical_pile_height() got to 4.5\n"); fflush(stdout);
#elif defined CYLINDER
      //printf("elliptical_pile_height() got to 4.6\n"); fflush(stdout);

      if (major*major+minor*minor<1.0)
	//height = pileprops->pileheight[ipile]/matprops->HEIGHT_SCALE;
	height = pileprops->pileheight[ipile];
      else height =0.0;
      //printf("elliptical_pile_height() got to 4.7\n"); fflush(stdout);
    ...
    //printf("elliptical_pile_height() got to 5\n"); fflush(stdout);
  }
     
  //printf("elliptical_pile_height() got to 6\n"); fflush(stdout);
  ...
  /* printf("(x,y,pile height) = (%E,%E,%E)\n",
   *(EmTemp->get_coord()),*(EmTemp->get_coord()+1),pileheight); */
